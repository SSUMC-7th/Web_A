        ...
        <Container>
            ...
            <MovieGrid>
                <MovieCard onClick={() => navigate('/movies/now-playing')}>
                    ...
                    <Overlay><Text>현재 상영중인</Text></Overlay>
                </MovieCard>
                <MovieCard onClick={() => navigate('/movies/popular')}>
                    <MovieImage src={Movie2} alt="인기있는 영화" />
                    <Overlay><Text>인기있는</Text></Overlay>
                </MovieCard>
                <MovieCard onClick={() => navigate('/movies/top-rated')}>
                    <MovieImage src={Movie3} alt="높은 평가를 받은 영화" />
                    <Overlay><Text>높은 평가를 받은</Text></Overlay>
                </MovieCard>
                <MovieCard onClick={() => navigate('/movies/upcoming')}>
                    <MovieImage src={Movie4} alt="개봉 예정중인 영화" />
                    <Overlay><Text>개봉 예정중인</Text></Overlay>
                </MovieCard>
                <MovieCard onClick={() => navigate('/movies/trending')}>
                    <MovieImage src={Movie5} alt="트렌딩 영화" />
                    <Overlay><Text>트렌딩 영화</Text></Overlay>
                </MovieCard>
                <MovieCard onClick={() => navigate('/actors/popular')}>
                    <MovieImage src={Movie6} alt="인기 배우" />
                    <Overlay><Text>인기 배우</Text></Overlay>
                </MovieCard>
            </MovieGrid>
        </Container>
    );
